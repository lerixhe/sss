...
const (
	...
	RECODE_SMSCDERR   = "4601"
	RECODE_IMAGECDERR = "4602"
)
...
var recodeText = map[string]string{
	...
	RECODE_ALREADREG:  "用户已注册",
	RECODE_IMAGECDERR: "图片验证码错误",
	RECODE_SMSCDERR:   "短信验证码错误",
